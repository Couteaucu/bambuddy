        ...
        <div className="mt-2 bg-bambu-dark rounded-lg p-3 space-y-2">
          ...
          {filamentComparison.map((item, idx) => (
            ...
            >
              ...
              {/* Force color match checkbox — shown for any non-perfect-match slot so the user can always enable or disable it */}
              {onForceColorMatchChange && item.status !== 'match' && item.slot_id != null && (
